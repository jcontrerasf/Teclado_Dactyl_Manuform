...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT_5x7(
        ...
        KC_LCTL,   KC_Z,    KC_X,    KC_C,   KC_V,   KC_B,
                            KC_NUBS, LT(_FN, TAB_L),
                                          KC_LALT,  KC_TAB, KC_LGUI,
                                                    LCTL(KC_RALT), KC_SPC,
        // right hand
                        KC_6,    KC_7,    KC_8,     KC_9,     KC_0,     KC_MINS,
                        KC_Y,    KC_U,    KC_I,     KC_O,     KC_P,     KC_LBRC,
                        KC_H,    KC_J,    KC_K,     KC_L,     KC_SCLN,  KC_DEL,
                        KC_N,    KC_M,    KC_COMM,  KC_DOT,   KC_QUOT,  KC_NUHS,
                                          TAB_R,    KC_SLASH,    
             KC_BSPC, KC_RBRC, KC_RSFT,
             KC_ENT,  KC_SPC
    ),
    ...
    [_FN] = LAYOUT_5x7(
        ...
        // right hand
                        ...
                        KC_KP_4,    KC_KP_5,    KC_KP_6,     KC_VOLD,     KC_UP,      LCTL(KC_0),
                        KC_KP_1,    KC_KP_2,    KC_KP_3,     KC_PDOT,     KC_DOWN,    KC_RIGHT,
                                                KC_KP_0,     KC_LEFT,    
